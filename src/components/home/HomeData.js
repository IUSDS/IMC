export const homeData = {
  hero: {
    ...
    narratives: [
      "White-glove delivery to airports, hotels, and private residences.",
      "Showroom-grade presentation. Seamless coordination.",
  ...
  about: {
    ...
    heading: "Curated luxury mobility across India",
    paragraphs: [
      "Indian Motor Club offers an elite fleet of exotic, luxury, and vintage automobiles across Delhi, Mumbai, Bangalore, Hyderabad, and Lucknow.",
      "From the regal 1939 Rolls-Royce to the high-octane Lamborghini Aventador, our collection is curated to make the extraordinary a part of your every milestone.",
      "We provide seamless, white-glove delivery to India’s premier hubs, including IGI T3, Mumbai General Aviation Terminal, and iconic landmarks like The Taj Mahal Palace and The Leela, ensuring an arrival that defines prestige."
    ]
  },
  howItWorks: [
  ...
  services: [
    ...
    { title: "WHITE-GLOVE SERVICE", desc: "A dedicated relationship executive manages every detail, from preparation and detailing to coordination and handover." },
    { title: "COMPLIMENTARY DELIVERY", desc: "Discreet delivery to five-star hotels, private residences, aviation terminals, and event venues across major Indian cities." },
    { title: "UNCOMPROMISING QUALITY", desc: "Every vehicle is maintained to international standards and presented in pristine, showroom-grade condition." },
    { title: "INDIA’S PREMIER FLEET", desc: "Privately managed vehicles ensure controlled allocation, accountability, and consistently high standards." },
