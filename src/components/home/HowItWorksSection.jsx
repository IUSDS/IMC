...
export default function HowItWorksSection() {
  ...
  return (
    <section ref={sectionRef} className="how-it-works-section relative w-full bg-[#0a0a0a]/10 text-white overflow-hidden z-10 border-t border-white/5 py-0 h-screen">
      <div
        ref={containerRef}
